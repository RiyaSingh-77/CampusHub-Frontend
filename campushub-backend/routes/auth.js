...
router.post('/register', async (req, res) => {
  try {
    const { name, rollNo, branch, year, section, phone, password, hostel } = req.body;
    ...
    const user   = await User.create({ name, rollNo, branch, year, section, phone, hostel, password: hashed });
